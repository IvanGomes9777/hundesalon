...
- [ ] Team prüfen (Namen / Rollen / Fotos) — und mit der **Mitarbeiterliste im Buchungssystem** abgleichen (aktuell: Mia, Jana, Mira, Tom)
- [ ] Leistungen & Preise prüfen
- [ ] Öffnungszeiten prüfen (aktuell **Mi–Sa 11–17**, Mo/Di/So geschlossen) — bestimmt die buchbaren Uhrzeiten
- [ ] Kontaktdaten prüfen: Telefon, E-Mail, Adresse (aktuell Telefon 01234 / 567 890, E-Mail Platzhalter `hallo@hundesalon-luna.de`)
